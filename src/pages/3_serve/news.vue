        ...
        <div class="essaies_lists">
          <div class="essaies_textBox1" v-if="essaies.length>0">
            ...
            <div class="essaies_textBox_con">
              <p>{{this.essaies[0].title}}</p>
              <!-- <p>{{this.essaies[0].content}}</p> -->
              <div class="goDetail" @click="goDetail(essaies[0].id)">详情</div>
            </div>
          </div>
          <div class="essaies_textBox2">
            <div class="essaies_textBox2_con" v-if="essaies.length>1">
              <div
                class="essaies_textBox_img"
                :style="{backgroundImage:'url('+ essaies[1].media +')'}"
              ></div>
              <div class="essaies_textBox_con">
                <p>{{this.essaies[1].title}}</p>
                <!-- <p>{{this.essaies[1].content}}</p> -->
                <div class="goDetail" @click="goDetail(essaies[1].id)">详情</div>
              </div>
            </div>
            <div class="essaies_textBox2_con" v-if="essaies.length>2">
              <div
                class="essaies_textBox_img"
                :style="{backgroundImage:'url('+ essaies[2].media +')'}"
              ></div>
              <div class="essaies_textBox_con">
                <p>{{this.essaies[2].title}}</p>
                <!-- <p>{{this.essaies[2].content}}</p> -->
...
export default {
  ...
  methods: {
    ...
    getInfo() {
      ...
      this.$axios({
        method: "post",
        url: "https://api.ltsjdx.com/index.php/website/News/index",
        data: data
      })
        .then(res => {
